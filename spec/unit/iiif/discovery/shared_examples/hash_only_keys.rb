...
shared_examples 'it has the appropriate methods for hash-only keys' do
  ...
  described_class.new.hash_only_keys.each do |prop|
    ...
    describe "#{prop}=" do
      ...
      it 'raises an exception when attempting to set it to something other than an Hash' do
